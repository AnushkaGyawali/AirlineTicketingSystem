	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<div id = "add">
				...
				<br>
				<form class="form-horizontal" action="adminjob.php" method="post" role="form" id="addf"> 
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<select class="form-control" id="airplanename2" placeholder="" name="airplanename2">
								...
								<option>Araniko</option>								          <option>Sagarmatha</option>
			...
			<form class="form-horizontal" role="form" id="rtsearch">
				...
				<form class="form-horizontal" role="form" action="adminjob.php" method="post" id="result">
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<label class="control-label col-sm-1" for="dairportdetail" id="ud1" ><font color="gray"></font></label>
					...
					<div class="form-group row" id="depair1">
						...
						<label class="control-label col-sm-1" for="dairportdetail" id="ud2" ><font color="gray"></font></label>
					...
					<div class="form-group row" id="arrair1">
						...
						<label class="control-label col-sm-1" for="dairportdetail" id="ud3" ><font color="gray"></font></label>
